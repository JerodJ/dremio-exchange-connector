...
@SourceType(value = "ExchangeARP", label = "Exchange",uiConfig = "exchange-layout.json")
public class ExchangeConf extends AbstractArpConf<ExchangeConf> {
  private static final String ARP_FILENAME = "arp/implementation/exchange-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.exchange.ExchangeDriver";
